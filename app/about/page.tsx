            ...
            <div className="space-y-6">
              <div className="bg-white rounded-xl shadow-sm p-5 border border-gray-100">
                ...
                <p className="text-gray-600 mb-3">
                  POS Analyzer is a powerful tool that helps you identify parts
                  of speech in any text. It uses natural language processing to
                ...
                <p className="text-gray-600">
                  ...
                  CSS, with natural language processing powered by
                  Compromise.js.
                </p>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="mt-4 text-xl text-gray-500">
              Learn more about our powerful NLP tool
            </p>
          </div>
            ...
            <div className="bg-white rounded-xl shadow-sm p-8 border border-gray-100">
              ...
              <div className="flex items-center space-x-6">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Government College Peshawar</p>
                </div>
              </div>
            </div>
